...
func (m *Matriz) Reporte() {
	texto := ""
	nombre_archivo := "./Vistas/matriz.dot"
	nombre_imagen := "./Vistas/matriz.jpg"
	aux1 := m.Raiz
	aux2 := m.Raiz
	aux3 := m.Raiz
	if aux1 != nil {
...
func (m *Matriz) GenerarImagen(nombre_imagen string) {
	archivoCSS := "Vistas/" + nombre_imagen + ".css" // csv/mario/mario.css
...
func (m *Matriz) generarHTML(nombre_imagen string) {
	archivoHTML := "Vistas/" + nombre_imagen + ".html"
